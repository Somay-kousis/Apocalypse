"""Control-plane unreachable from workers (control 7). See controls/control_spec.yaml for pass_condition + verification.
...
def run(target_dir: str) -> CheckResult:
    ...
    raise NotImplementedError("control 7 not implemented")
