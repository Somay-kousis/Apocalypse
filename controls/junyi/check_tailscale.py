"""No reusable VPN keys + startup detection (control 8). See controls/control_spec.yaml for pass_condition + verification.
...
def run(target_dir: str) -> CheckResult:
    ...
    raise NotImplementedError("control 8 not implemented")
