...
| 6 | Measure: block rate, survival rate (N), alt paths, SLA hits/misses, blast-radius breach | `validation/run_checks.py` -> `report/results.md`; unmeasured fields are labeled explicitly |
